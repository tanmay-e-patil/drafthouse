...
export function AuthLayout({
  ...
  return (
    <main className="relative grid min-h-screen overflow-hidden bg-background text-foreground lg:grid-cols-[1.05fr_0.95fr]">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_15%_18%,oklch(0.88_0.05_255_/_0.42),transparent_32%),radial-gradient(circle_at_80%_8%,oklch(0.86_0.08_145_/_0.28),transparent_28%)] dark:bg-[radial-gradient(circle_at_15%_18%,oklch(0.45_0.14_255_/_0.22),transparent_32%),radial-gradient(circle_at_80%_8%,oklch(0.42_0.12_145_/_0.16),transparent_28%)]" />
...
function BrandingPoint({
  ...
  return (
    <div className="flex gap-4 rounded-2xl border border-border bg-background/70 p-4 shadow-sm backdrop-blur">
